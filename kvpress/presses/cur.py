...
class CURPress(ScorerPress):
    ...
    def score(
        ...
        leverage_scores = combined_leverage_scores(
            keys,
            values,
            r=20,
            method=self.leverage_type,
            random=self.use_random_leverage,
            local_window_size=self.local_window_size,
            use_local_approximation=self.use_local_approximation,
        )
