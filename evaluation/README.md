...
- On kv-retrieval subtask, mistral-nemo-instruct-2407 performs poorly compared to other models and is thus excluded from the plots.
- For longbook-choice-eng, many compression methods are able to obtain good compression ratios.
