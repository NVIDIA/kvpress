...
PRESS_REGISTRY = {
    ...
    "tova": TOVAPress(),
    "no_press": None,
    "expected_attention_10_100": ExpectedAttentionPress(n_future_positions=100, n_samples=10),
    "expected_attention_10_500": ExpectedAttentionPress(n_future_positions=500, n_samples=10),
    "expected_attention_10_2000": ExpectedAttentionPress(n_future_positions=2000, n_samples=10),
    "expected_attention_10_100_no_sink": ExpectedAttentionPress(n_future_positions=100, n_samples=10, remove_sink_for_stats=False),
    "expected_attention_10_500_no_sink": ExpectedAttentionPress(n_future_positions=500, n_samples=10, remove_sink_for_stats=False),
    "expected_attention_10_2000_no_sink": ExpectedAttentionPress(n_future_positions=2000, n_samples=10, remove_sink_for_stats=False),
    "expected_attention_100_100": ExpectedAttentionPress(n_future_positions=100, n_samples=100),
    "expected_attention_100_500": ExpectedAttentionPress(n_future_positions=500, n_samples=100),
    "expected_attention_100_2000": ExpectedAttentionPress(n_future_positions=2000, n_samples=100),
    "expected_attention_100_100_no_sink": ExpectedAttentionPress(n_future_positions=100, n_samples=100, remove_sink_for_stats=False),
    "expected_attention_100_500_no_sink": ExpectedAttentionPress(n_future_positions=500, n_samples=100, remove_sink_for_stats=False),
    "expected_attention_100_2000_no_sink": ExpectedAttentionPress(n_future_positions=2000, n_samples=100, remove_sink_for_stats=False),
    "adakv_expected_attention_e2_10_100": AdaKVPress(ExpectedAttentionPress(epsilon=1e-2, n_future_positions=100, n_samples=10)),
}
