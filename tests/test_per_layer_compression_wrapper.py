...
from kvpress.prunners.per_layer_compression_press import PerLayerCompressionPress
...
def test_per_layer_compression_press(unit_test_model):  # noqa: F811
    press = PerLayerCompressionPress(compression_ratios=[0.1, 1], press=KnormScorer())
